...
{	
	/// <summary>
	/// This is an excellent open source tool that creates images from icon fonts by Nikola Irinchev.
	/// The introductory blog post can be found on Medium at the following address:
	/// https://medium.com/@nirinchev/using-icon-fonts-with-xamarin-forms-16da98c98e05#.fsgqrq1u0
	/// Additionally, the complete code can be found on GitHub at the following address:
	/// https://github.com/nirinchev/XamarinIconFonts
	/// </summary>
